...
%mt=matfile('transferfields_0070000.mat')
%m=matfile('lambda_0070000.mat');
...
h1=figure('OuterPosition',...
    [x1 y1 x2 y2]);
isosurface(X,Z,Y+1,m.lambda2./lrms,-1,(mt.voz-mt.woy)./(-ut^2))
%(mt.voz-mt.woy)./(-ut^2) )
...
saveas(h1,'iso_lambda2_flp_70000.fig')
