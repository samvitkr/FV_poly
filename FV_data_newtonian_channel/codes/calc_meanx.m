...
vd=squeeze(mean( (m.v).*(m.lambda2<lt),2))';
wd=squeeze(mean( (m.w).*(m.lambda2<lt),2))';
ozd=squeeze(mean( (m.dvdx-m.dudy-dUdy).*(m.lambda2<lt),2))';
oyd=squeeze(mean( (m.dudz-m.dwdx).*(m.lambda2<lt),2))';
vozd=squeeze(mean( (m.v).*(m.dvdx-m.dudy-dUdy).*(m.lambda2<lt),2))';
woyd=squeeze(mean( (m.w).*(m.dudz-m.dwdx).*(m.lambda2<lt),2))';
ld=squeeze(mean( (m.lambda2).*(m.lambda2<lt),2))';

vu=squeeze(mean( (mu.v).*(mu.lambda2<lt),2))';
wu=squeeze(mean( (mu.w).*(mu.lambda2<lt),2))';
ozu=squeeze(mean( (mu.dvdx-mu.dudy-dUdy).*(mu.lambda2<lt),2))';
oyu=squeeze(mean( (mu.dudz-mu.dwdx).*(mu.lambda2<lt),2))';
vozu=squeeze(mean( (mu.v).*(mu.dvdx-mu.dudy-dUdy).*(mu.lambda2<lt),2))';
woyu=squeeze(mean( (mu.w).*(mu.dudz-mu.dwdx).*(mu.lambda2<lt),2))';
lu=squeeze(mean( (mu.lambda2).*(mu.lambda2<lt),2))';
