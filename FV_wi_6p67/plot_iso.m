...
mt=matfile('velgrad_transfer_flp_0040000.mat')
m=matfile('lambdaflp_0040000.mat');
%mt=matfile('polyfields_0050000.mat')

%mt=matfile('transferfields_0057000.mat')
%m=matfile('lambda_0057000.mat');
...
h1=figure('OuterPosition',...
    [x1 y1 x2 y2]);
isosurface(X,Z,Y+1,m.lambda2,-0.02,(mt.voz-mt.woy)./(-ut^2))
%(mt.voz-mt.woy)./(-ut^2) )
...
saveas(h1,'iso_lambda2_flp_0040000.fig')
