...
%mgt=matfile(fmgt,'Writable',true)
%
...
[Kx,Kz]=meshgrid(kx.get_radial_frequency_vector(),kz.get_radial_frequency_vector());
D=zeros(Nz,Nx,Ny);
for j=20:95
...
%mgf.poly=ft.transform_to_physical( ( mgt.polyF).*(D.^2));
