...
jcond=156;
fn=sprintf('velfield_lse_voz_j_%03d.mat',jcond);
...
%         end
    ...
    fg=sprintf('velgradfield_lseQ2_voz_j_%03d.mat',jcond);
    fng=fullfile(runFolder,fg);
    mg=matfile(fng,'Writable',true)
    mg.u=mv.uQ2;
    mg.v=mv.vQ2;
    mg.w=mv.wQ2;
...
%         mv.Q4omegax=single(omegaX);
    ...
    fg=sprintf('velgradfield_lseQ4_voz_j_%03d.mat',jcond);
    fng=fullfile(runFolder,fg);
    mg=matfile(fng,'Writable',true)
    mg.u=mv.uQ4;
    mg.v=mv.vQ4;
