...
L151=           single(zeros(Nz,Nx));
L161=           single(zeros(Nz,Nx));
L171=           single(zeros(Nz,Nx));
...
%	    k
	    ...
	    L151(k,i)=  single(real(L(15,1)));
            L161(k,i)=  single(real(L(16,1)));
            L171(k,i)=  single(real(L(17,1)));
	...
	mf.L151(1:Nz,1:Nx,j)=L151;
        mf.L161(1:Nz,1:Nx,j)=L161;
        mf.L171(1:Nz,1:Nx,j)=L171;
