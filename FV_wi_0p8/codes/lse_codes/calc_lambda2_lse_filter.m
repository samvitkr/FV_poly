...
%fvg=sprintf('../data/velgradfield_lse_ddfilter_Q2_j_%03d.mat',jcond);
fvg=sprintf('../data/velgradfield_lse_uufilter_Q2_j_%03d.mat',jcond);
...
%fvg=sprintf('../data/velgradfield_lse_ddfilter_Q4_j_%03d.mat',jcond);
fvg=sprintf('../data/velgradfield_lse_uufilter_Q4_j_%03d.mat',jcond);
mvg=matfile(fvg,'Writable',true);
