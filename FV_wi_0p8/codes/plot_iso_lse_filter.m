...
mq1=mean(abs(m.Q4Q),'all')
mq2=mean(abs(mu.Q4Q),'all')
x1=150;
y1=150;
x2=1000;
y2=350;
...
permute(m.Q2Q,[2 1 3]), lt, permute((1e+3)*m.fxQ2,[2 1 3]))
%isosurface( permute(m.Z,[2 1 3]), permute(m.X,[2 1 3]), permute(m.Y,[2 1 3]),...
...
permute(mu.Q2Q,[2 1 3]), lt, permute((1e+3)*mu.fxQ2,[2 1 3])) 
%isosurface( permute(m.Z,[2 1 3]), permute(m.X,[2 1 3]), permute(m.Y,[2 1 3]),...
...
%zlabel('y')
%grid on
f1=sprintf("iso_lse_vel_voz_Q1e-3_filter_j_%03d.fig",jcond)
saveas(h1,f1)
%%
